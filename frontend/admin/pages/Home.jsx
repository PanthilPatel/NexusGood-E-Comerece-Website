...
import { ShoppingBag, ArrowRight, Zap, ShieldCheck, Globe, Star, ChevronRight } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group hidden lg:block">
             ...
             <div className="relative aspect-[4/5] bg-white/[0.02] border border-white/10 rounded-[3rem] p-8 overflow-hidden shadow-2xl">
                <img 
                ...
                <div className="absolute inset-x-8 bottom-8 p-8 glass-card space-y-4 translate-y-4 group-hover:translate-y-0 transition-transform">
                   <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-1 text-amber-400"><Star size={12} fill="currentColor" /><Star size={12} fill="currentColor" /><Star size={12} fill="currentColor" /></div>
                   </div>
                   <h4 className="text-xl font-bold">Horizon Zero One</h4>
                   <p className="text-xs font-light line-clamp-1 opacity-70">The ultimate synchronization artifact for digital workspace optimization.</p>
                   <div className="flex justify-between items-center pt-2">
                      <span className="text-lg font-bold text-[var(--text-heading)]">₹24,999</span>
                      <button className="p-2 bg-primary text-white rounded-xl shadow-lg shadow-primary/20"><ChevronRight size={16} /></button>
                   </div>
                </div>
             </div>
          </div>
      ...
      <section className="py-32 px-6">
         <div className="max-w-7xl mx-auto bg-gradient-to-br from-indigo-600 to-indigo-900 rounded-[3rem] p-16 md:p-24 text-center space-y-10 shadow-2xl shadow-indigo-500/20 relative overflow-hidden">
            ...
            <p className="text-xl text-indigo-100/70 font-light max-w-2xl mx-auto leading-relaxed">
               Join 48,000+ visionaries who have already synchronized their workspace with ShopElite artifacts.
            </p>
